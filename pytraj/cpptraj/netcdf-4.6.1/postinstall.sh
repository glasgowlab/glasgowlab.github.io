...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lm " CFLAGS="-I/Users/anumglasgow/Dropbox/lab_website/anumazam.github.io/pytraj/cpptraj/include" LDFLAGS="-L/Users/anumglasgow/Dropbox/lab_website/anumazam.github.io/pytraj/cpptraj/lib" ./configure --prefix=/Users/anumglasgow/Dropbox/lab_website/anumazam.github.io/pytraj/cpptraj $STATIC_BUILD $SHARED_BUILD
        LIBS="-lm " make
        LIBS="-lm " make check
    fi
